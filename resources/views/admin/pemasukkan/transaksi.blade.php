                        ...
                        <tbody>
                            @forelse ($transaksis as $pemasukkan)
                                <tr>
                                    ...
                                    <td>
                                        <button type="button" class="btn btn-success btn-sm" title="Edit" data-toggle="modal" data-target="#editModal" onclick="openEditModal('{{ $pemasukkan->murid }}', '{{ $pemasukkan->murid }}', '{{ $pemasukkan->kelas }}', '{{ $pemasukkan->kategori_transaksi }}', '{{ $pemasukkan->tanggal }}', '{{ $pemasukkan->nominal }}'">
            ...
            <div class="modal-body">
                ...
                <form id="edit_action" class="edit-action-form" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="nama_edit" name="id_siswa" value="{{ $murid->nama_murid }}" required>
                    </div>
...
<script>
    function openEditModal(id, murid, kelas, kategori_transaksi, tanggal, nominal) {
...
@endif
    ...
    <script>
        function redirectToClass() {
            ...
            var redirectURL = "{{ route('download-pdf') }}?selectedClass=" + encodeURIComponent(selectedValue);        var redirectURL = "?search=" + encodeURIComponent(selectedValue);
